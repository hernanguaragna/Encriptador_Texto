...
Se ingresa el texto a encriptar.
Se presiona el botón "Encriptar" para cifrar el mensaje.
Se presiona el botón "Copiar" para realizar una copia del mensaje encriptado.
Posteriormente se pega en la parte izquierda, en el encriptador y se oprime el botón "Desencriptar" para obtener el mensaje cifrado
Listo!
